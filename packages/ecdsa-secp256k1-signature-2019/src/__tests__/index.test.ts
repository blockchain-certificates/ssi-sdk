...
describe('EcdsaSecp256k1Signature2019', () => {
  describe('signs a document', () => {
    ...
    describe('adds suite context', function () {
      it('if context includes "https://www.w3.org/ns/credentials/v2"', async () => {
        ...
        expect(signedDocument).toEqual({
          ...
          'proof': {
            'created': '2021-04-20T00:00:00Z',
            'jws': 'eyJhbGciOiJFUzI1NksiLCJiNjQiOmZhbHNlLCJjcml0IjpbImI2NCJdfQ..RxkBbypbH75IjLZdEIxB4TPysFFq2o7DHykwooNDQQlqq7DtsCL5b102n2ZXze9BnHqaEwc12NgVueAdEyV-cA',
            'proofPurpose': 'assertionMethod',
            'type': 'EcdsaSecp256k1Signature2019',
            'verificationMethod': 'did:example:signer#123'
          }
