...
describe('EcdsaSecp256k1VerificationKey2019', () => {
  describe('class', () => {
    test('has extra properties', () => {
      expect(EcdsaSecp256k1VerificationKey2019).toHaveProperty('suite', 'EcdsaSecp256k1VerificationKey2019')
      expect(EcdsaSecp256k1VerificationKey2019).toHaveProperty('SUITE_CONTEXT', 'https://ns.did.ai/suites/secp256k1-2019/v1')
    })
  })
  ...
  describe('constructor', () => {
    ...
    test('throw if no publicKey58 is provided', () => {
      ...
      expect(error).toMatchInlineSnapshot('[TypeError: The "publicKeyBase58" property is required.]')
